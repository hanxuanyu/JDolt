...
public class ProcedureResult<T> {
     ...
     * 全参构造器
     */
    private ProcedureResult(Integer status, String msg, T data) {
        this.status = status;
        this.msg = msg;
        this.data = data;
    }
     ...
     */
    public static <E> ProcedureResult<E> success(String msg, E data) {
     ...
     */
    public static <E> ProcedureResult<E> success(String msg) {
     ...
     * 构造简单的成功消息，使用默认的msg
     */
    public static <E> ProcedureResult<E> success() {
        return success("成功");
    }
     ...
     * @return
     */
    public static <T> ProcedureResult<T> failed(String msg) {
     ...
     * 构造带有默认msg字段的失败消息
     */
    public static <T> ProcedureResult<T> failed() {
        return failed("失败");
    }
